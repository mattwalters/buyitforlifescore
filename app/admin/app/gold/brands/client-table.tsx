...
export default function BrandClientTable({
  ...
  const [visibleColumns, setVisibleColumns] = useState<Set<string>>(
    new Set(["canonicalName", "avgSentiment", "mentionCount", "createdAt"]),
  );
                      ...
                      visibleColumns.has(col.key) && (
                        ...
                        >
                          {col.key === "canonicalName" ? (
                            ...
                            <div
                              className={`inline-flex items-center justify-center rounded-full border px-2.5 py-0.5 text-xs font-semibold ${getSentimentVariant(brand.avgSentiment)}`}
                            >
