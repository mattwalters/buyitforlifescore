...
from pipeline.utils.pricing import calculate_gemini_cost, AiModel
...
async def semantically_equivalent(client, expected: str, actual: str, field: str, semaphore: asyncio.Semaphore) -> bool:
    ...
    if expected is None and actual is None: return True, 0.0
    if expected is None or actual is None: return False, 0.0
